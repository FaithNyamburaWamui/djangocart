...
# from api.serializer import MaterialSerializer 
...
#                     self.cart[material_id]['quantity'] += quantity
#             else:
#                 self.cart[material_id] = {'quantity': quantity, 'price': material.get('price', '0.00')}
...
#         """
#         del self.session[settings.CART_SESSION_ID]  # Remove the cart from the session
#         self.save() 
